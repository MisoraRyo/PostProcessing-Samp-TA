...
void main() {
	...
	float R = mix(bg_color.r, col.r+ uStep, (dispMask.r*uStep*1.0 + uStep) );
	float G = mix(bg_color.g, col.g+ uStep, (dispMask.g*uStep*1.0 + uStep) );
	float B = mix(bg_color.b, col.b+ uStep, (dispMask.b*uStep*1.0 + uStep) );
	////////////////////////////////////////////////////////////////////////////////////////
	// 出力
